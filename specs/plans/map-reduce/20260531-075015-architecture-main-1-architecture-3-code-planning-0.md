...
| ARCH3-C5 | Benchmark evidence must compare worker counts 1, 2, 4, and 8 on a large mixed-language repository at a fixed repository state. | `specs/arch-plan/map-reduce/20260531-074032-architecture-main-1-architecture-3.md:22-33` | Task 2 | Covered |
